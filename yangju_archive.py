...
st.markdown("""
<style>
body, .stApp { background: #181d29 !important; }
.retro-header {
    ...
    margin-top: 44px;
    margin-bottom: 20px;
    text-shadow: 0 0 14px #00f2fe, 0 0 30px #232946;
    padding: 24px 0 16px 0;
    border-radius: 24px;
    background: linear-gradient(90deg, #232946 60%, #00f2fe55 100%);
    border: 6px solid #0dfcff;
    box-shadow: 0 0 42px #00f2fe88, 0 10px 45px #191a23;
}
.retro-buttons {
    display: flex;
...
.retro-btn {
    ...
    border-radius: 50%;
    background: radial-gradient(circle at 25% 30%, #ff6f91 70%, #b01532 100%);
    box-shadow: 0 0 13px #ff6f91cc, 0 2px 7px #23294655;
    border: 3px solid #800910;
    display: inline-block;
}
.retro-btn.blue {
    background: radial-gradient(circle at 30% 30%, #52e1ff 70%, #156680 100%);
    box-shadow: 0 0 13px #41e8eec2, 0 2px 7px #23294655;
    border: 3px solid #0973a6;
}
.retro-btn.yellow {
    background: radial-gradient(circle at 33% 33%, #ffe95f 70%, #948012 100%);
    box-shadow: 0 0 13px #fffa6fcc, 0 2px 7px #23294655;
    border: 3px solid #807109;
}
.stTabs [role="tab"] {
    font-family: 'Press Start 2P', monospace;
    font-size: 1.14rem;
...
.stTabs [role="tab"][aria-selected="true"] {
    ...
    text-shadow: 0 0 8px #00f2fe80;
}
.stTabs [role="tab"]:hover { color: #40f6ff; }
.pixel-border {
    border: 4px solid #0dfcff;
    border-radius: 19px;
    background: #232946f2;
    box-shadow: 0 0 14px #00f2fe55;
...
# ---- HEADER + 네온 버튼 ----
st.markdown('<div class="retro-header">양주시 아카이브 GAME</div>', unsafe_allow_html=True)
st.markdown("""
<div class="retro-buttons">
    <div class="retro-btn"></div>
    <div class="retro-btn blue"></div>
    <div class="retro-btn yellow"></div>
    <div class="retro-btn"></div>
</div>
""", unsafe_allow_html=True)
...
with tabs[0]:
    ...
    st.markdown("""
    <div style='font-size:15pt; color:#fff; font-family: NanumGothicCoding, monospace; margin-top:14px;'>
