...
with tabs[0]:
    ...
    """, unsafe_allow_html=True)
    st.image("양주 관야지.jpg", caption="양주 관아지(양주목 관아터)", width=740)
    st.markdown("""
    ...
    """, unsafe_allow_html=True)
    st.image("회암사지.jpg", caption="회암사지 터", width=740)
    st.image("회암사지 복원도.jpg", caption="회암사지 추정 복원도", width=740)
    st.markdown("""
    <div style='font-size:15pt; color:#fff; font-family: NanumGothicCoding, monospace; margin-top:15px;'>
    ...
    """, unsafe_allow_html=True)
    st.image("양주 장흥 순교성지.jpg", caption="양주 장흥 순교성지", width=740)
    st.markdown("""
    <div style='font-size:15pt; color:#fff; font-family: NanumGothicCoding, monospace; margin-top:15px;'>
    <b>4. 농업과 장터</b><br>
    ...
    """, unsafe_allow_html=True)
    st.image("양주 농촌.jpg", caption="1950~1980년대 논 모내기 풍경(경기북부, 양주 일대)", width=740)
    st.image("양주 장터.jpg", caption="1970~1980년대 시골 장터(경기북부, 양주 일대)", width=740)
    st.markdown("""
    <div style='font-size:15pt; color:#fff; font-family: NanumGothicCoding, monospace; margin-top:15px;'>
    <b>5. 한국전쟁과 양주</b><br>
    - 1·4 후퇴 시 주요 격전지<br>
    ...
    """, unsafe_allow_html=True)
    st.image("양주 1.4후퇴.jpg", caption="1951년 1.4후퇴 당시 경기북부(양주 일대) 피난민 행렬", width=740)
...
with tabs[1]:
    ...
    """, unsafe_allow_html=True)
    st.image("양주시 면적.jpg", caption="양주시 행정구역도", width=740)
    st.markdown("""
    <div style='font-size:15pt; color:#fff; font-family: NanumGothicCoding, monospace; margin-top:15px;'>
    ...
    """, unsafe_allow_html=True)
    st.image("양주 옥정신도시.jpg", caption="양주 옥정 신도시 전경", width=740)
    st.markdown("""
    <div style='font-size:15pt; color:#fff; font-family: NanumGothicCoding, monospace; margin-top:15px;'>
    <b>3. 산업기반 확충</b><br>
    ...
    """, unsafe_allow_html=True)
    st.image("양주 산업단지.jpg", caption="양주 은남일반산업단지(조감도)", width=740)
    st.markdown("""
    <div style='font-size:15pt; color:#fff; font-family: NanumGothicCoding, monospace; margin-top:15px;'>
    ...
    """, unsafe_allow_html=True)
    st.image("양주시 나리농원 천일홍 축제.jpg", caption="양주시 나리농원 천일홍 축제", width=740)
    st.markdown("""
    <div style='font-size:15pt; color:#fff; font-family: NanumGothicCoding, monospace; margin-top:15px;'>
    ...
    """, unsafe_allow_html=True)
    st.image("양주 옥정 호수공원.jpg", caption="양주 옥정 호수공원", width=740)
    st.markdown('</div>', unsafe_allow_html=True)
...
with tabs[2]:
    ...
    """, unsafe_allow_html=True)
    st.image("양주 GTX 노선도.jpg", caption="양주를 지나는 GTX-C(예정) 노선", width=740)
    st.markdown("""
    <div style='font-size:15pt; color:#fff; font-family: NanumGothicCoding, monospace; margin-top:15px;'>
    <b>2. 첨단산업과 창업도시</b><br>
    - 테크노밸리, 산업단지 중심 개발<br>
    ...
    """, unsafe_allow_html=True)
    st.image("양주 테크노벨리.png", caption="양주 테크노밸리(조감도)", width=740)
    st.markdown("""
    <div style='font-size:15pt; color:#fff; font-family: NanumGothicCoding, monospace; margin-top:15px;'>
    <b>3. 문화예술 중심도시</b><br>
    - 장흥문화예술촌 레지던시 확대<br>
    ...
    """, unsafe_allow_html=True)
    st.image("양주 문화 예술.jpg", caption="양주 장흥문화예술촌(실내/전시)", width=740)
    st.markdown("""
    <div style='font-size:15pt; color:#fff; font-family: NanumGothicCoding, monospace; margin-top:15px;'>
    <b>4. 탄소중립 스마트시티</b><br>
    - 스마트 교통, AI 행정 도입<br>
    ...
    """, unsafe_allow_html=True)
    st.image("양주 탄소중립 스마트시티.jpg", caption="양주 생태공원 및 친환경 스마트시티", width=740)
    st.markdown("""
    <div style='font-size:15pt; color:#fff; font-family: NanumGothicCoding, monospace; margin-top:15px;'>
    <b>5. 교육·복지 인프라</b><br>
    - 국공립 유치원 및 학교 확충<br>
    ...
    """, unsafe_allow_html=True)
    st.image("양주시 청년센터.jpg", caption="양주시 청년센터(옥정동)", width=740)
    st.markdown('</div>', unsafe_allow_html=True)
